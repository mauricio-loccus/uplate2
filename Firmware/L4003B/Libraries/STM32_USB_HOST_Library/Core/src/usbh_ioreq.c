...
// printf("    BulkSd : hc_num:[%d] ep_is_in:[%d] xfer_buff:[0x%08x] xfer_len:[%d]  [toggle_out:%d] \r\n",hc_num ,pdev->host.hc[hc_num].ep_is_in,buff,
// length,pdev->host.hc[hc_num].toggle_out);
