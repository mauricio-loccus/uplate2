...
*/
//modify
#define   NET_BASE_ADDR			0x68002000   //0x64002000 注:NE1=1   NE2=2   NE3=4   NE4=8
...
#if 1
	timing.FMC_AddressSetupTime = 5;//5  FMC161127
	timing.FMC_AddressHoldTime = 0;//0
	timing.FMC_DataSetupTime = 16;//8
	timing.FMC_BusTurnAroundDuration = 4;//2
